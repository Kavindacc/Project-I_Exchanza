    ...
    <div class="container text-center">
        <div class="row row-col-6 catr">
            ...
            <div class="col r1">
                ...
                <a href="item_template.php?cat=women&sub=tops"><!--iteam show page-->
            ...
            <div class="col r2">
                <a href="item_template.php?cat=women&sub=dresses">
            ...
            <div class="col r3">
                <a href="item_template.php?cat=women&sub=pants">
            ...
            <div class="col r4">
                <a href="item_template.php?cat=women&sub=accessories">
            ...
            <div class="col r5">
                <a href="item_template.php?cat=women&sub=bags">
            ...
            <div class="col r6">
                <a href="item_template.php?cat=women&sub=shoes">
