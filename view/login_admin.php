...
<body>
        ...
        <div class="container-fluid logo"><!--logo-->
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <a href="login_admin.php" class=" text-decoration-none"><button class="lo-button btn-sm ms-2 px-3" style="color:#ffff;">login</button></a>
    ...
    <div class="d-flex justify-content-center align-items-center"style="height:80vh;">
        <div class="container py-2">
            ...
            Are you a user? <a href="login_user.php">Login as User</a>
            </div>
            </div>
            <div class="row justify-content-center">
                <?php if (isset($_GET['error'])) { ?>
                    <div class="col-md-8 col-lg-5 bg-warning text-white"><?php echo $_GET['error']; ?></div>
                <?php } ?>
            ...
            <form action="../control/logincon.php" method="post">
                <div class="row justify-content-center mb-2">
                    <div class="col-md-8 col-lg-5">
                        ...
                        <input type="email" class="form-control" placeholder="exampladmine@gmail.com" name="email" required="">
                    </div>
                </div>
                <div class="row justify-content-center ">
                    <div class="col-md-8 col-lg-5">
